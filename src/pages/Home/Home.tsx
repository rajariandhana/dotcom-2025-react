    ...
    return (
        <section>
            ...
            <h1 className="font-mono font-bold">
                🌎 <span className="text-indigo-rose motion-preset-pop ">Hello, world!</span>
            </h1>
            ...
            <ul className="flex items-center w-fit gap-2">
                <li>
                    <a href="https://instagram.com/rajariandhana" target="_blank">
                        <svg className="size-8 text-gray-800 funny-rotate" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="https://github.com/rajariandhana" target="_blank" >
                        <svg className="size-8 text-gray-800 funny-rotate" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
